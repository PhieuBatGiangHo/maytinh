...
product.thumbnail,product.externalcontent, product.content, product.updated_at, category.name 
category_name from product left join category on 
product.id_category = category.id where category.id='.$id;
...
foreach ($productList as $item) {
    ...
    <a href="detail.php?id='.$item['id'].'"><p>'.$item['externalcontent'].'</p></a>
    </div>';
